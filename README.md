...
raw CDP execution, Web Storage/cookie/Cache Storage controls, and a
default-profile auto-connect keepalive daemon with local command routing plus a
cron-safe `daemon keepalive` command are in place.
