...
func capabilityCatalog() []map[string]any {
	return []map[string]any{
		...
		capabilityRow("emulation", "implemented", "viewport, media, color-scheme, user-agent, geolocation, timezone, locale, CPU throttling, network throttling, responsive audit", []string{"cdp emulate viewport --help", "cdp emulate media --help", "cdp emulate color-scheme --help", "cdp emulate user-agent --help", "cdp emulate geolocation --help", "cdp emulate timezone --help", "cdp emulate locale --help", "cdp emulate cpu --help", "cdp emulate network --help"}, []string{"cdp workflow responsive-audit 'https://example.com' --json", "cdp emulate network --preset slow-3g --json"}),
	}
}
