...
func schemaCatalog() map[string]schemaInfo {
	return map[string]schemaInfo{
		...
		"rendered-extract-content": {
			...
			Description: "Content-profile provenance for generic HTML conversion, arXiv semantic paper extraction, or Hacker News discussion-tree extraction.",
			Fields: []schemaField{
				{Name: "mode", Type: "string", Required: true, Description: "Requested content extractor mode: auto or generic."},
				{Name: "profile", Type: "string", Required: true, Description: "Resolved source profile: generic, arxiv, or hacker-news."},
				...
				{Name: "item_count", Type: "number", Required: false, Description: "Native semantic item count: arXiv sections or Hacker News comments."},
