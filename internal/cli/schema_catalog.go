	...
	return map[string]schemaInfo{
		...
		"page-cleanup": {
			...
			Fields: []schemaField{
				...
				{Name: "cleanup", Type: "page_cleanup_summary", Required: true, Description: "Dry-run flag, filters, selected page, ready/would-close counts, close-required hint, wait-gone settings, close concurrency, closed count, state warnings, and next commands."},
				{Name: "candidates", Type: "array<page_cleanup_candidate>", Required: true, Description: "Page targets considered with visibility state, hidden flag, keep reason, close error, target-gone state, and per-target close evidence."},
