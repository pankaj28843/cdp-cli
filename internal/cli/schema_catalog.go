	...
	return map[string]schemaInfo{
		...
		"workflow-web-research-serp": {
			...
			Fields: []schemaField{
				...
				{Name: "workflow", Type: "workflow_summary", Required: true, Description: "Selected SERP engines, reusable engine lanes, fallback SERP metadata, primary/fallback counts, scheduled result pages, progress mode, fast-fail settings, parallelism, navigation delay, output directory, and next commands. navigation_delay is the cancellable minimum between navigation starts in each engine lane, with no delay before the first navigation; parallel engine lanes are paced independently."},
			},
		},
		"web-research-query": {
