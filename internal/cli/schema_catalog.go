...
func schemaCatalog() map[string]schemaInfo {
	catalog := map[string]schemaInfo{
		...
		"workflow-google-maps-directions": {
			...
			Description: "Read-only Google Maps driving or public-transit route cards with endpoint identity, trust, and exact cleanup evidence.",
			Fields: []schemaField{
				...
				{Name: "query", Type: "object", Required: true, Description: "Requested origin, destination, and travel mode."},
				...
				{Name: "routes", Type: "array<google_maps_route>", Required: true, Description: "Complete, deduplicated visible route cards with duration plus driving distance or transit time-window evidence."},
				...
				{Name: "shortest_route", Type: "google_maps_route", Required: false, Description: "Minimum-distance visible driving route; omitted for public transit."},
