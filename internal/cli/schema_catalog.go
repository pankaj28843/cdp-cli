	...
	return map[string]schemaInfo{
		...
		"workflow-web-research-serp": {
			...
			Fields: []schemaField{
				...
				{Name: "workflow", Type: "workflow_summary", Required: true, Description: "SERP, query count, candidate count, scheduled result pages, progress mode, fast-fail settings, parallelism, output directory, and next commands."},
			},
		},
