...
func schemaCatalog() map[string]schemaInfo {
	return map[string]schemaInfo{
		...
		"workflow-rendered-extract": {
			...
			Description: "Rendered research extraction from a newly created URL target or a uniquely selected existing target, with SPA-aware readiness, ownership-safe cleanup, quality gates, Markdown, and SERP links.",
			Fields: []schemaField{
				...
				{Name: "workflow", Type: "workflow_summary", Required: true, Description: "Trigger, created/reused/reloaded/closed ownership, bounded exact-target cleanup status and recovery command, selected formats, and collector metadata."},
			},
		},
