	...
	return map[string]schemaInfo{
		...
		"workflow-action-capture": {
			...
			Fields: []schemaField{
				...
				{Name: "evidence", Type: "object", Required: false, Description: "Before/after text, DOM, and action-window event evidence summaries with artifact references when --evidence-out-dir is used."},
				{Name: "artifacts", Type: "array<artifact>", Required: false, Description: "Screenshot, before/after evidence, action event evidence, and JSON artifact references."},
			},
		},
		"workflow-a11y": {
			Name:        "workflow-a11y",
