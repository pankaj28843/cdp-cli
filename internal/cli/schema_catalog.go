...
func schemaCatalog() map[string]schemaInfo {
	return map[string]schemaInfo{
		...
		"workflow-submit-search": {
			...
			Description: "Locator-driven search input workflow that fills or types a query, optionally submits with Enter, and verifies text, selector, or URL state while preserving target evidence.",
			Fields: []schemaField{
				...
				{Name: "workflow", Type: "workflow_summary", Required: true, Description: "Workflow name, input_mode, input_strategy, submit mode, submit key, wait_requested flag, verification state, and poll interval."},
