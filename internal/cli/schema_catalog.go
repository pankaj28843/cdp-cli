...
func schemaCatalog() map[string]schemaInfo {
	return map[string]schemaInfo{
		...
		"click": {
			Name:        "click",
			Description: "DOM or raw-input mouse click operation with optional actionability trial, post-action verification, and final target evidence.",
			Fields: []schemaField{
				...
				{Name: "action", Type: "string", Required: true, Description: "Action name: clicked for dispatched clicks, trial for --trial checks."},
				...
				{Name: "click", Type: "click_result", Required: true, Description: "Selector, matched count, strategy, coordinates for raw-input or trial checks, verification status, trial flag, and final URL/title."},
				{Name: "actionability", Type: "actionability_result", Required: true, Description: "Actionability evidence for attached, visible, stable, receives-events, enabled, editable, and in-viewport checks."},
		...
		"fill": {
			Name:        "fill",
			Description: "Set the value of the first matching form control, or run non-mutating fill actionability checks with --trial.",
			Fields: []schemaField{
				...
				{Name: "action", Type: "string", Required: true, Description: "Action name: filled for value updates, trial for --trial checks."},
				{Name: "target", Type: "page", Required: true, Description: "Selected page target metadata."},
				{Name: "fill", Type: "fill_result", Required: true, Description: "Selector, matched count, filled boolean, trial flag, and previous/current values."},
				{Name: "actionability", Type: "actionability_result", Required: true, Description: "Actionability evidence for attached, visible, enabled, editable, and supporting checks."},
				{Name: "locator", Type: "locator_find_result", Required: false, Description: "Strict locator resolution details when --by is not css."},
		...
		"assert-visible": {
			Name:        "assert-visible",
			Description: "Element visibility assertion result for CSS selector or strict locator.",
			Fields: []schemaField{
				{Name: "ok", Type: "boolean", Required: true, Description: "True when at least one selected element is visible."},
				{Name: "target", Type: "page", Required: true, Description: "Selected page target metadata."},
				{Name: "assertion", Type: "assert_visibility_result", Required: true, Description: "Selector, expected state, pass/fail status, matched count, visible/hidden counts, and bounded item diagnostics."},
				{Name: "locator", Type: "locator_find_result", Required: false, Description: "Strict locator resolution details when --by is not css."},
				{Name: "resolved_selector", Type: "string", Required: false, Description: "Unique CSS selector hint selected from the locator before asserting."},
			},
		},
