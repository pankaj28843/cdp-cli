	...
	return map[string]schemaInfo{
		...
		"workflow-debug-bundle": {
			...
			Fields: []schemaField{
				...
				{Name: "workflow", Type: "workflow_summary", Required: true, Description: "Workflow name, requested URL, counts, next commands, collector status, redaction mode, inline payload policy, run id, task id, and stage."},
			},
		},
