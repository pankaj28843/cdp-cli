	...
	return map[string]schemaInfo{
		...
		"wait": {
			...
			Fields: []schemaField{
				...
				{Name: "last_event", Type: "network_dialog_file_chooser_or_popup_wait_event", Required: false, Description: "Last observed request/response candidate, network-idle lifecycle event, dialog event, file chooser event, or popup target event."},
