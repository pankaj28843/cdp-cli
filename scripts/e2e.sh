...
"$binary" describe --command "click" --json | jq -e '.ok == true and .commands.name == "click" and (.commands.examples | any(contains("--by role"))) and (.commands.examples | any(contains("--trial"))) and (.commands.examples | any(contains("--force"))) and (.commands.examples | any(contains("--wait-popup"))) and (.commands.examples | any(contains("--wait-download"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role")) and (.commands.flags[] | select(.name == "trial")) and (.commands.flags[] | select(.name == "force")) and (.commands.flags[] | select(.name == "wait-popup")) and (.commands.flags[] | select(.name == "wait-popup-url")) and (.commands.flags[] | select(.name == "wait-popup-title")) and (.commands.flags[] | select(.name == "wait-download")) and (.commands.flags[] | select(.name == "wait-download-url")) and (.commands.flags[] | select(.name == "wait-download-filename")) and (.commands.flags[] | select(.name == "download-dir"))' >/dev/null
