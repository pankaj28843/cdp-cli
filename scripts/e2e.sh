...
"$binary" describe --command "click" --json | jq -e '.ok == true and .commands.name == "click" and (.commands.examples | any(contains("--by role"))) and (.commands.examples | any(contains("--trial"))) and (.commands.examples | any(contains("--force"))) and (.commands.examples | any(contains("--wait-popup"))) and (.commands.examples | any(contains("--wait-download"))) and (.commands.examples | any(contains("--wait-dialog"))) and (.commands.examples | any(contains("--wait-file-chooser"))) and (.commands.examples | any(contains("--wait-request"))) and (.commands.examples | any(contains("--wait-response"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role")) and (.commands.flags[] | select(.name == "trial")) and (.commands.flags[] | select(.name == "force")) and (.commands.flags[] | select(.name == "wait-popup")) and (.commands.flags[] | select(.name == "wait-popup-url")) and (.commands.flags[] | select(.name == "wait-popup-title")) and (.commands.flags[] | select(.name == "wait-download")) and (.commands.flags[] | select(.name == "wait-download-url")) and (.commands.flags[] | select(.name == "wait-download-filename")) and (.commands.flags[] | select(.name == "download-dir")) and (.commands.flags[] | select(.name == "wait-dialog")) and (.commands.flags[] | select(.name == "wait-dialog-action")) and (.commands.flags[] | select(.name == "wait-dialog-message-contains")) and (.commands.flags[] | select(.name == "wait-file-chooser")) and (.commands.flags[] | select(.name == "wait-file-chooser-mode")) and (.commands.flags[] | select(.name == "wait-request")) and (.commands.flags[] | select(.name == "wait-request-match-url")) and (.commands.flags[] | select(.name == "wait-request-method")) and (.commands.flags[] | select(.name == "wait-response")) and (.commands.flags[] | select(.name == "wait-response-match-url")) and (.commands.flags[] | select(.name == "wait-response-status"))' >/dev/null
"$binary" describe --command "fill" --json | jq -e '.ok == true and .commands.name == "fill" and (.commands.examples | any(contains("--by label"))) and (.commands.examples | any(contains("--trial"))) and (.commands.examples | any(contains("--force"))) and (.commands.examples | any(contains("--wait-selector"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role")) and (.commands.flags[] | select(.name == "trial")) and (.commands.flags[] | select(.name == "force")) and (.commands.flags[] | select(.name == "wait-text")) and (.commands.flags[] | select(.name == "wait-selector")) and (.commands.flags[] | select(.name == "poll"))' >/dev/null
"$binary" describe --command "type" --json | jq -e '.ok == true and .commands.name == "type" and (.commands.examples | any(contains("--by label"))) and (.commands.examples | any(contains("--trial"))) and (.commands.examples | any(contains("--force"))) and (.commands.examples | any(contains("--wait-text"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role")) and (.commands.flags[] | select(.name == "trial")) and (.commands.flags[] | select(.name == "force")) and (.commands.flags[] | select(.name == "wait-text")) and (.commands.flags[] | select(.name == "wait-selector")) and (.commands.flags[] | select(.name == "poll"))' >/dev/null
"$binary" describe --command "press" --json | jq -e '.ok == true and .commands.name == "press" and (.commands.examples | any(contains("--by label"))) and (.commands.examples | any(contains("--trial"))) and (.commands.examples | any(contains("--wait-text"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role")) and (.commands.flags[] | select(.name == "trial")) and (.commands.flags[] | select(.name == "wait-text")) and (.commands.flags[] | select(.name == "wait-selector")) and (.commands.flags[] | select(.name == "poll"))' >/dev/null
...
"$binary" schema fill --json | jq -e '.ok == true and .schema.name == "fill" and (.schema.fields | map(.name) | index("fill")) and (.schema.fields | map(.name) | index("actionability")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector")) and (.schema.fields | map(.name) | index("verification"))' >/dev/null
...
"$binary" schema type --json | jq -e '.ok == true and .schema.name == "type" and (.schema.fields | map(.name) | index("type")) and (.schema.fields | map(.name) | index("actionability")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector")) and (.schema.fields | map(.name) | index("verification"))' >/dev/null
"$binary" schema press --json | jq -e '.ok == true and .schema.name == "press" and (.schema.fields | map(.name) | index("press")) and (.schema.fields | map(.name) | index("actionability")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("verification"))' >/dev/null
