...
"$binary" describe --command "assert value" --json | jq -e '.ok == true and .commands.name == "value" and (.commands.examples | any(contains("--by label"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert text" --json | jq -e '.ok == true and .commands.name == "text" and (.commands.examples | any(contains("--by role"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert visible" --json | jq -e '.ok == true and .commands.name == "visible" and (.commands.examples | any(contains("--by role"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert hidden" --json | jq -e '.ok == true and .commands.name == "hidden" and (.commands.examples | any(contains("--by role"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert enabled" --json | jq -e '.ok == true and .commands.name == "enabled" and (.commands.examples | any(contains("--by role"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert disabled" --json | jq -e '.ok == true and .commands.name == "disabled" and (.commands.examples | any(contains("--by role"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert editable" --json | jq -e '.ok == true and .commands.name == "editable" and (.commands.examples | any(contains("--by label"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert readonly" --json | jq -e '.ok == true and .commands.name == "readonly" and (.commands.examples | any(contains("--by label"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert checked" --json | jq -e '.ok == true and .commands.name == "checked" and (.commands.examples | any(contains("--by label"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
"$binary" describe --command "assert unchecked" --json | jq -e '.ok == true and .commands.name == "unchecked" and (.commands.examples | any(contains("--by label"))) and (.commands.flags[] | select(.name == "by")) and (.commands.flags[] | select(.name == "role"))' >/dev/null
...
"$binary" describe --command "workflow web-research serp" --json | jq -e '.ok == true and .commands.name == "serp" and (.commands.examples | any(contains("--serp google"))) and (.commands.examples | any(contains("--serp duckduckgo"))) and (.commands.examples | any(contains("--fallback-serp google"))) and (.commands.examples | any(contains("--result-pages 3"))) and (.commands.examples | any(contains("--fast-fail-blocked"))) and (.commands.examples | any(contains("--progress stderr"))) and (.commands.flags[] | select(.name == "serp" and (.usage | contains("duckduckgo")))) and (.commands.flags[] | select(.name == "fallback-serp" and (.usage | contains("auto")))) and (.commands.flags[] | select(.name == "candidate-out")) and (.commands.flags[] | select(.name == "result-pages")) and (.commands.flags[] | select(.name == "fast-fail-blocked")) and (.commands.flags[] | select(.name == "blocked-failure-threshold")) and (.commands.flags[] | select(.name == "progress"))' >/dev/null
...
"$binary" schema assert-value --json | jq -e '.ok == true and .schema.name == "assert-value" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-text --json | jq -e '.ok == true and .schema.name == "assert-text" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-visible --json | jq -e '.ok == true and .schema.name == "assert-visible" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-hidden --json | jq -e '.ok == true and .schema.name == "assert-hidden" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-enabled --json | jq -e '.ok == true and .schema.name == "assert-enabled" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-disabled --json | jq -e '.ok == true and .schema.name == "assert-disabled" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-editable --json | jq -e '.ok == true and .schema.name == "assert-editable" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-readonly --json | jq -e '.ok == true and .schema.name == "assert-readonly" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-checked --json | jq -e '.ok == true and .schema.name == "assert-checked" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
"$binary" schema assert-unchecked --json | jq -e '.ok == true and .schema.name == "assert-unchecked" and (.schema.fields | map(.name) | index("assertion")) and (.schema.fields | map(.name) | index("locator")) and (.schema.fields | map(.name) | index("resolved_selector"))' >/dev/null
